...
export const VIDEO_MODEL_PRICES = [
  ...
  },
  {
    ...
    isPerSecondPricing: true,
    prices: [
      { aspectRatio: '16:9', price: EXPRESS_VIDEO_CREDITS_PER_SECOND_BY_MODEL['SEEDANCE2.5I2V'] },
      { aspectRatio: '9:16', price: EXPRESS_VIDEO_CREDITS_PER_SECOND_BY_MODEL['SEEDANCE2.5I2V'] },
    ],
