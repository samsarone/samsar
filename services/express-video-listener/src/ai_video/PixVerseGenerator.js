...
export async function requestRenderPixVerseVideo(payload) {
  ...
  const { videoSessionId, layerId, prompt, combineLayers, useStartFrame,
    ...
    expressGenerativeVideoModelSubType} = payload;
  ...
  if (payload.expressGenerativeVideoModelSubType) {
    aiVideoRenderPayload.animationType = payload.expressGenerativeVideoModelSubType;
  }


  aiVideoRenderPayload.duration = currentLayer.duration;
