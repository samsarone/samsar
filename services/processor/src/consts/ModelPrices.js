...
export const VIDEO_MODEL_PRICES = [
  ...
  },
  {
    ...
    isTextToVideoModel: false,
    prices: [
      { aspectRatio: '1:1', price: EXPRESS_VIDEO_CREDITS_PER_SECOND_BY_MODEL.KLINGIMGTOVIDTURBO },
      { aspectRatio: '16:9', price: EXPRESS_VIDEO_CREDITS_PER_SECOND_BY_MODEL.KLINGIMGTOVIDTURBO },
      { aspectRatio: '9:16', price: EXPRESS_VIDEO_CREDITS_PER_SECOND_BY_MODEL.KLINGIMGTOVIDTURBO },
    ],
    pricingDistribution: getExpressVideoPricingDistributionPerSecond('KLINGIMGTOVIDTURBO'),
    units: [5, 10],
  },
  {
    key: 'HAPPYHORSEI2V',
  ...
  },
  {
    ...
    prices: [
      { aspectRatio: '16:9', price: EXPRESS_VIDEO_CREDITS_PER_SECOND_BY_MODEL['SEEDANCE2.0I2V'] },
      { aspectRatio: '9:16', price: EXPRESS_VIDEO_CREDITS_PER_SECOND_BY_MODEL['SEEDANCE2.0I2V'] },
    ],
