...
export const SUPPORTED_SUBTITLE_FONTS_BY_LANGUAGE = Object.freeze(
  Object.fromEntries(
    Object.entries(LANGUAGE_SUBTITLE_FONT_MAP).map(([languageCode, fonts]) => [
      languageCode,
      Object.freeze([...fonts]),
    ])
  )
...
export function resolveSubtitleFont(languageCode, requestedFont) {
  ...
  if (requestedFont && typeof requestedFont === 'string') {
    ...
    // If the default Latin font was requested for a non-Latin language, fall back to the first supported font
    if (
