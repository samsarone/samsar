...
async function getUserProviderUsageLogs(userId, options = {}) {
  ...
  const normalizedItems = items.map((item) => ({
    ...
    teamOwnerUserId: item.teamOwnerUserId || item.metadata?.teamOwnerUserId || null,
    teamMemberUserId: item.teamMemberUserId || item.metadata?.teamMemberUserId || null,
    teamMemberName: item.teamMemberName || item.metadata?.teamMemberName || null,
    teamMemberEmail: item.teamMemberEmail || item.metadata?.teamMemberEmail || null,
