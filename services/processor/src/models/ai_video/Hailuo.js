...
export async function requestRenderHailuoVideo(payload) {

  const { videoSessionId, currentLayerId, prompt, combineLayers, useStartFrame,
    useEndFrame, aspectRatio, model , clipLayerToAiVideo, userId, usePromptOptimizer, 
  duration } = payload;
  ...
  aiVideoRenderPayload.usePromptOptimizer = usePromptOptimizer;
