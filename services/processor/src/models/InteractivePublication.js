...
export function serializeInteractivePublication(publication) {
  ...
  return {
    ...
    categories: normalizeTags(source.categories),
    topics: normalizeTags(source.topics),
...
export async function createInteractivePublicationForSessionVideo(
  ...
  try {
    ...
    const publicationData = {
      ...
      categories: normalizeTags(payload.categories).slice(0, 3),
      topics: normalizeTags(payload.topics).slice(0, 8),
