...
export async function generateThemeKeywords(textListString, aspectRatio = '1:1', userInferenceModel = 'gpt-6-astra') {
...
export async function updateThemeWithText(themeJson, textListString, aspectRatio = '1:1', userInferenceModel = 'gpt-6-astra') {
...
export async function generatePromptsForText(textList, themeJson, aspectRatio = '1:1',
  userInferenceModel = 'gpt-6-astra', shortForm = false) {
...
export async function updatePromptWithTheme(prompt, themeJson, aspectRatio = '1:1',
  userInferenceModel = 'gpt-6-astra', shortForm = false, videoTone = 'cinematic') {
...
export async function sendAssistantMessageRequest(messageList, userInferenceModel = 'gpt-6-astra') {
...
export async function sendSessionThemeMessageRequest(messageList, userInferenceModel = 'gpt-6-astra') {
...
export async function sendSessionPromptMessageRequest(messageList, themeObject, userInferenceModel = 'gpt-6-astra') {
