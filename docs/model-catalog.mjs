...
const notes = {
  ...
  GPTIMAGE2: 'Stable Samsar key for GPT Image 2.5. Legacy GenBlaze GPT Image 2 routes are excluded from this model.',
  GPTIMAGE2EDIT: 'Stable Samsar key for GPT Image 2.5 editing. Legacy GenBlaze routes are excluded.',
